 ...
 * All rights reserved.
 */
// @openqa-edit vendored from packages/page-controller/src/actions.ts (see
// ./VENDORED.md); imports flattened to sibling modules. Upstream's
// executeJavascript lives in PageController.ts, which is NOT vendored — no
// eval pathway exists here (enforced by CI grep).
import type { InteractiveElementDomNode } from './dom_tree.js'
import {
	clickPointer,
	disablePassThrough,
	enablePassThrough,
